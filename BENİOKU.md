...
Kararlılığı ve adil kullanımı sağlamak amacıyla, bu API'de istek sınırlandırması (15 dakikada 33 istek) uygulanmaktadır. Eğer uygulamanızın yüksek hacimde istek yapması gerekiyorsa ve sürekli olarak bu sınırlara takılıyorsanız, lütfen aşağıdaki seçenekleri değerlendirin:
